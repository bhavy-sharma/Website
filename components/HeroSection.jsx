...
import { ArrowDown, Sparkles, Rocket, Zap, Circle } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(79, 70, 229, 0.15) 0%, rgba(0, 0, 0, 0) 50%)`,
        }}
      />
      ...
      >
        ...
        >
          {[
            ...
            { value: "24/7", label: "Support", icon: Circle },
            { value: "100%", label: "Client Satisfaction", icon: Sparkles },
          ].map((stat, i) => (
            <motion.div key={i} className="text-center" whileHover={{ y: -5 }}>
